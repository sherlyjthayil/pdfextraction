		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapbtppdfupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtppdfupload-display": {
								"semanticObject": "sapbtppdfupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.pdfupload",
									"url": sap.ui.require.toUrl("sap/btp/pdfupload")
								}
							}
						}
					}
